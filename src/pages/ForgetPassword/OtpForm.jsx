...
const handleSubmit = async () => {
  ...
  if (!passwordRegex.test(password)) {
    toast.error(
      "Password must contain at least 1 capital letter, 1 number, 1 symbol and be at least 8 characters long"
    );
    return;
  }
  ...
  try {
    ...
    window.location.href = "/consumer?mode=login";
  } catch (err) {
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-red-100">
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-red-600 font-medium mt-2">Code expires in 10 minutes!</p>
              </div>
                    ...
                    {otp.map((digit, index) => (
                      ...
                      />
                            ...
                            <button
                              ...
                              disabled={isLoading}
                              className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition mt-6"
                            >
