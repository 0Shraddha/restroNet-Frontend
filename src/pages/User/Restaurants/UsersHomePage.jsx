...
//     : restaurantList;
  ...
  <div className="flex flex-wrap gap-3">
    {[...userPreferences.cuisines, ...userPreferences.category, ...userPreferences.tags].map((pref, i) => (
      <span
        key={i}
  ...
  <div className="mt-4">
    <button
      ...
      className="px-5 py-2 bg-gray-900 text-white text-sm rounded-lg font-medium shadow hover:bg-gray-800 transition"
    >
      ...
      <div className="px-8 py-3 text-sm text-gray-700 font-medium">
        Showing <b>{filteredRestaurants.length}</b> recommended restaurants for you.
      </div>
              ...
              >
                <div className="flex">
                  ...
                  <div className="flex-1 p-5 flex flex-col">
                    <h2 className="text-xl font-bold text-gray-900">{item.restaurant_name}</h2>
                    ...
                    <button
                      ...
                      className="bg-red-600 text-white mt-auto px-4 py-2 rounded-lg hover:bg-red-700 transition font-medium shadow"
                    >
                      View Details
                    </button>
